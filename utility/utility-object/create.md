...
[https://github.com/ddzy/ts-utility-plugins/tree/master/src/ddzy/utility/object/create](https://github.com/ddzy/ts-utility-plugins/tree/master/src/ddzy/utility/object/create)

### 用法

{% code title="create.test.ts" %}
```typescript
